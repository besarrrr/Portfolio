...
function About() {
  return (
    <section className="my-5">
        ...
        engineering bootcamp through the University of Texas at Austin and I am currently open for work. I am excited about applying what I have
        ...
        Javascript, Bootstrap, AJAX, SASS
        <br></br>
        Backend: MySQL, MongoDB, Express,
        ReactJS, Node, Handlebars, Firebase,
        AWS, Webpack, Gulp
